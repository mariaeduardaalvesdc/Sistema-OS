...
<div class="container">
    <h2> PESQUISA POR RG </h2>
        <form action="pesq_rg.php" method="POST">
        <div class="row">
                        <input type="text" name="pesq_rg">
    ...
    <h5> Dados do cliente   </h5>
        <table class="table table-striped">
            ...
            <tbody> 
               <?php
                $pesq_rg = @$_POST['pesq_rg'];
                $sql = "SELECT * FROM clientes WHERE rg LIKE '%".$pesq_rg."%'";
