...
<div class="container">
    <h2> PESQUISA POR CIDADE </h2>
        <form action="pesq_cidade.php" method="POST">
        <div class="row">
            <input type="text" name="pesq_cidade">
    ...
    <h5> DADOS DO CLIENTE   </h5>
        <table class="table table-striped">
            ...
            <tbody> 
               <?php
                $pesq_cidade = @$_POST['pesq_cidade'];
                $sql = "SELECT * FROM clientes WHERE cidade LIKE '%".$pesq_cidade."%'";
