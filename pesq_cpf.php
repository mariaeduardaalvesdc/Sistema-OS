...
<div class="container">
    <h2>PESQUISA POR CPF</h2>
        <form action="pesq_cpf.php" method="POST">
        <div class="row">
            <input type="text" name="pesq_cpf">
    ...
    <h5> Dados do cliente   </h5>
        <table class="table table-striped">
            ...
            <tbody> 
               <?php
                $pesq_cpf = @$_POST['pesq_cpf'];
                $sql = "SELECT * FROM clientes WHERE cpf LIKE '%".$pesq_cpf."%'";
